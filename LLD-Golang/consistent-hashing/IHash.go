...
IHash interface represents a hash function.
It contains: Hash method.

ModHash struct implements IHash interface.
It contains: size of the hash ring.

RandomHash struct implements IHash interface.
