...
ConsistentHashMap represents a consistent hashing ring.
It contains: hashring array, number of replicas and hash function.
...
// todo:  this func  can be modified to (n log n) considering hash ring to be sorted map/ sorted set
// use binary search
